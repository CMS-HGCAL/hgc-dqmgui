...
update "guidelines_rotated_m15p0.h" "${destination}/style"
update "guidelines_rotated_m25p0.h" "${destination}/style"
update "guidelines_rotated_m5p0.h" "${destination}/style"
